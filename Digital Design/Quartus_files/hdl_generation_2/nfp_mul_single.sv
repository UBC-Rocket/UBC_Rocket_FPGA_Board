// -------------------------------------------------------------
// 
// File Name: hdlsrc/hdl_generation_2/nfp_mul_single.sv
...
// Source Path: hdl_generation_2/nfp_mul_single
// Hierarchy Level: 2
// Model version: 1.34
// 
...
module nfp_mul_single
  ...
  logic [6:0] Constant2_out1_1;  /* ufix7 */
  logic Constant1_out1_2;
  logic Constant3_out1_1;
  logic Switch_out1_2;
  logic [7:0] Bit_Concat1_out1_1;  /* uint8 */
  logic Switch1_out1_1;
  logic [31:0] Subtract_add_temp;  /* ufix32 */
  logic [31:0] Subtract_1;  /* ufix32 */
  logic [31:0] Subtract_2;  /* ufix32 */
  logic [8:0] Subtract_out1;  /* ufix9 */
  logic [7:0] Bit_Concat_out1_2;  /* uint8 */
  logic [31:0] Add1_add_temp;  /* ufix32 */
  logic [31:0] Add1_1;  /* ufix32 */
  logic [31:0] Add1_2;  /* ufix32 */
  logic [8:0] Add1_out1;  /* ufix9 */
  logic signed [31:0] Subtract2_sub_temp;  /* sfix32 */
  logic signed [31:0] Subtract2_1;  /* sfix32 */
  logic signed [31:0] Subtract2_2;  /* sfix32 */
  logic signed [9:0] Subtract2_out1;  /* sfix10 */
  logic signed [9:0] Constant4_out1_1;  /* sfix10 */
  logic signed [9:0] Switch2_out1_1;  /* sfix10 */
  logic signed [9:0] Constant_out1_1;  /* sfix10 */
  logic signed [9:0] Switch1_out1_2;  /* sfix10 */
  logic signed [31:0] Add_add_temp;  /* sfix32 */
  ...
  logic signed [9:0] Constant1_out1_3;  /* sfix10 */
  logic signed [9:0] Switch2_out1_2;  /* sfix10 */
  logic Compare_To_Constant1_out1_1;
  ...
  logic Logical_Operator10_out1;
  logic Logical_Operator_out1_4;
  logic Compare_To_Constant_out1_2;
  logic [7:0] Constant1_out1_4;  /* uint8 */
  logic [48:0] Bit_Shift_out1;  /* ufix49 */
  logic [48:0] Switch_out1_3;  /* ufix49 */
  logic [47:0] Bit_Slice_out1;  /* ufix48 */
  logic [1:0] Bit_Slice2_out1;  /* ufix2 */
  logic Bit_Slice4_out1;  /* ufix1 */
  logic [21:0] Bit_Slice1_out1_1;  /* ufix22 */
  logic Bit_Reduce_out1;  /* ufix1 */
  logic Bit_Slice5_out1;  /* ufix1 */
  logic Bit_Slice3_out1;  /* ufix1 */
  logic Logical_Operator1_out1_3;
  logic Logical_Operator_out1_5;
  logic [22:0] Bit_Slice1_out1_2;  /* ufix23 */
  logic [23:0] Delay2_out1_dtc;  /* ufix24 */
  logic Constant_out1_2;
  logic [31:0] Add_add_temp_1;  /* ufix32 */
  logic [31:0] Add_4;  /* ufix32 */
  logic [31:0] Add_5;  /* ufix32 */
  logic [23:0] Add_out1_1;  /* ufix24 */
  logic [23:0] Switch_out1_4;  /* ufix24 */
  logic Bit_Slice2_out1_1;  /* ufix1 */
  logic [31:0] Add1_add_temp_1;  /* ufix32 */
  logic [31:0] Add1_4;  /* ufix32 */
  logic [31:0] Add1_5;  /* ufix32 */
  logic [7:0] Add1_out1_1;  /* uint8 */
  logic signed [31:0] Add_add_temp_2;  /* sfix32 */
  logic signed [31:0] Add_7;  /* sfix32 */
  logic signed [31:0] Add_8;  /* sfix32 */
  logic [7:0] Add_out1_2;  /* uint8 */
  logic [7:0] Constant1_out1_5;  /* uint8 */
  logic [7:0] Switch1_out1_3;  /* uint8 */
  logic [7:0] Constant4_out1_2;  /* uint8 */
  logic Switch1_out1_4;
  logic [7:0] Switch4_out1;  /* uint8 */
  logic [7:0] Switch6_out1;  /* uint8 */
  logic [22:0] Bit_Slice4_out1_1;  /* ufix23 */
  logic [22:0] Bit_Shift_out1_1;  /* ufix23 */
  logic [22:0] Switch1_out1_5;  /* ufix23 */
  logic [22:0] Constant2_out1_2;  /* ufix23 */
  logic [22:0] Switch2_out1_3;  /* ufix23 */
  logic [22:0] Constant5_out1_1;  /* ufix23 */
  logic [22:0] Bit_Set_out1;  /* ufix23 */
  logic [22:0] Switch7_out1;  /* ufix23 */
