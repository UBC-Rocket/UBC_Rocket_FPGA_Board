module Project_test(LEDS, SWITCHES, CLK_250, reset); 
    parameter NUMBER_OF_SUM_BLOCKS = 1;
    ...
    parameter NUMBER_OF_DOT_PRODUCT_BLOCKS = 0;
    parameter NUMBER_OF_SAT_BLOCKS = 0;
    parameter NUMBER_OF_SIGNUM_BLOCKS = 0;
