// -------------------------------------------------------------
// 
// File Name: hdlsrc/hdl_generation_2/nfp_sub_single.sv
...
// Source Path: hdl_generation_2/nfp_sub_single
// Hierarchy Level: 2
// Model version: 1.34
// 
...
module nfp_sub_single
  ...
  logic bitconcat_aExponent_aMantissa_out1;  /* ufix1 */
  logic Logical_Operator_out1;  /* ufix1 */
  logic Logical_Operator1_out1;  /* ufix1 */
  logic [7:0] if_bitconcat_aExponent_aMantiss_out1;  /* ufix8 */
  ...
  logic exp_norm_cfType_Exponent_In_out1;  /* ufix1 */
  logic alphaExponent_0_cfType_Exp_out1;  /* ufix1 */
  logic [2:0] alpha1_out1;  /* ufix3 */
  logic [2:0] alpha0_out1;  /* ufix3 */
  logic [2:0] if_Exponent_0_cfType_Exp_out1;  /* ufix3 */
  logic [22:0] if_bitconcat_aExponent_aMantiss_1_out1;  /* ufix23 */
  logic [25:0] Bit_Concat_out1;  /* ufix26 */
  logic [1:0] alpha0_1_out1;  /* ufix2 */
  logic [27:0] Bit_Concat1_out1;  /* ufix28 */
  logic signed [27:0] Data_Type_Conversion_out1;  /* sfix28 */
  logic Logical_Operator_out1_1;  /* ufix1 */
  logic if_bitconcat_aExponent_aMantiss_2_out1;  /* ufix1 */
  logic if_bitconcat_aExponent_aMantiss_5_out1;  /* ufix1 */
  logic bitxor_out1;  /* ufix1 */
  logic [7:0] if_bitconcat_aExponent_aMantiss_3_out1;  /* ufix8 */
  logic exp_b_cfType_Exponent_Inf_o_out1;  /* ufix1 */
  logic Exponent_0_out1_1;  /* ufix1 */
  logic alphaExponent_0_cfType_Exp_out1_1;  /* ufix1 */
  logic [2:0] alpha1_out1_1;  /* ufix3 */
  logic [2:0] alpha0_out1_1;  /* ufix3 */
  logic [2:0] if_Exponent_0_cfType_Exp_out1_1;  /* ufix3 */
  logic [22:0] if_bitconcat_aExponent_aMantiss_4_out1;  /* ufix23 */
  logic [25:0] Bit_Concat_out1_1;  /* ufix26 */
  logic [1:0] alpha0_1_out1_1;  /* ufix2 */
  logic [27:0] Bit_Concat1_out1_1;  /* ufix28 */
  logic signed [27:0] Data_Type_Conversion_out1_1;  /* sfix28 */
  logic signed [28:0] alphamant_b_ext_in0;  /* sfix29 */
  logic signed [28:0] alphamant_b_ext_1;  /* sfix29 */
  logic signed [27:0] alphamant_b_ext_out1;  /* sfix28 */
  logic signed [27:0] if_opp_Sign_out1;  /* sfix28 */
  logic [7:0] C_out1_1;  /* ufix8 */
  logic [7:0] if_Exponent_0_out1_1;  /* ufix8 */
  logic signed [31:0] storedInteger_exp_a_cor_sto_1;  /* sfix32 */
  logic signed [31:0] storedInteger_exp_a_cor_sto_2;  /* sfix32 */
  logic signed [31:0] storedInteger_exp_a_cor_sto_out1;  /* int32 */
  logic [2:0] Bit_Slice2_out1;  /* ufix3 */
  logic Compare_To_Zero_out1;  /* ufix1 */
  logic [4:0] Constant_out1;  /* ufix5 */
  logic [4:0] Bit_Slice_out1;  /* ufix5 */
  logic [4:0] if_opp_Sign_1_out1;  /* ufix5 */
  logic [7:0] dynamic_shift_1;  /* uint8 */
  logic signed [27:0] bitsra_mant_b_ext_shift_lengt_out1;  /* sfix28 */
  logic signed [31:0] mant_a_ext_mant_b_shifted_add_temp;  /* sfix32 */
  logic signed [31:0] mant_a_ext_mant_b_shifted_1;  /* sfix32 */
  logic signed [31:0] mant_a_ext_mant_b_shifted_2;  /* sfix32 */
  logic [26:0] mant_a_ext_mant_b_shifted_out1;  /* ufix27 */
  logic BitSlice_out1;  /* ufix1 */
  logic Logical_Operator_out1_2;  /* ufix1 */
  logic [25:0] BitSlice3_out1;  /* ufix26 */
  logic Bit_Slice5_out1;  /* ufix1 */
  logic Bit_Slice3_out1;  /* ufix1 */
  logic Logical_Operator1_out1_1;  /* ufix1 */
  logic [7:0] Bit_Slice2_out1_1;  /* ufix8 */
  ...
  logic Logical_Operator14_out1;  /* ufix1 */
  logic Logical_Operator13_out1;  /* ufix1 */
  logic Logical_Operator12_out1;  /* ufix1 */
  logic [7:0] Bit_Slice1_out1;  /* ufix8 */
  logic Bit_Slice16_out1_1;  /* ufix1 */
  logic Bit_Slice15_out1_1;  /* ufix1 */
  logic Logical_Operator5_out1_1;  /* ufix1 */
  logic Bit_Slice14_out1_1;  /* ufix1 */
  logic Bit_Slice13_out1_1;  /* ufix1 */
  logic Logical_Operator7_out1_1;  /* ufix1 */
  logic Logical_Operator6_out1_1;  /* ufix1 */
  logic Bit_Slice12_out1_1;  /* ufix1 */
  logic Bit_Slice11_out1_1;  /* ufix1 */
  logic Logical_Operator4_out1_1;  /* ufix1 */
  logic Bit_Slice10_out1_1;  /* ufix1 */
  logic Bit_Slice9_out1_1;  /* ufix1 */
  logic Logical_Operator14_out1_1;  /* ufix1 */
  logic Logical_Operator13_out1_1;  /* ufix1 */
  logic [7:0] Bit_Slice4_out1;  /* ufix8 */
  ...
  logic [4:0] Constant_out1_1;  /* ufix5 */
  logic [4:0] Constant1_out1;  /* ufix5 */
  logic [4:0] Switch_out1;  /* ufix5 */
  logic Logical_Operator_out1_3;  /* ufix1 */
  logic [4:0] Constant2_out1;  /* ufix5 */
  logic [4:0] Switch1_out1;  /* ufix5 */
  logic [4:0] Constant3_out1;  /* ufix5 */
  logic [4:0] Switch2_out1;  /* ufix5 */
  logic [4:0] Constant4_out1;  /* ufix5 */
  logic Logical_Operator2_out1;  /* ufix1 */
  logic [4:0] Switch3_out1;  /* ufix5 */
  logic [4:0] Switch4_out1;  /* ufix5 */
  logic [4:0] Constant5_out1;  /* ufix5 */
  logic [4:0] Switch5_out1;  /* ufix5 */
  logic [4:0] Constant6_out1;  /* ufix5 */
  logic [4:0] Switch6_out1;  /* ufix5 */
  logic [4:0] Constant7_out1;  /* ufix5 */
  logic [4:0] Switch7_out1;  /* ufix5 */
  logic [4:0] Constant8_out1;  /* ufix5 */
  logic [4:0] Switch8_out1;  /* ufix5 */
  logic Logical_Operator12_out1_1;  /* ufix1 */
  logic [4:0] Switch9_out1;  /* ufix5 */
  logic [4:0] Switch10_out1;  /* ufix5 */
  logic [4:0] Constant9_out1;  /* ufix5 */
  logic [4:0] Switch11_out1;  /* ufix5 */
  logic [4:0] Constant10_out1;  /* ufix5 */
  logic [4:0] Switch12_out1;  /* ufix5 */
  logic [4:0] Constant11_out1;  /* ufix5 */
  logic [4:0] Switch14_out1;  /* ufix5 */
  logic [4:0] Constant12_out1;  /* ufix5 */
  logic [4:0] Switch15_out1;  /* ufix5 */
  logic [4:0] Switch16_out1;  /* ufix5 */
  logic [4:0] Constant13_out1;  /* ufix5 */
  logic [4:0] Switch17_out1;  /* ufix5 */
  logic [4:0] Constant14_out1;  /* ufix5 */
  logic [4:0] Switch18_out1;  /* ufix5 */
  logic [4:0] Constant15_out1;  /* ufix5 */
  logic [4:0] Switch19_out1;  /* ufix5 */
  logic [4:0] Constant16_out1;  /* ufix5 */
  logic [4:0] Switch20_out1;  /* ufix5 */
  logic [4:0] Switch21_out1;  /* ufix5 */
  logic Logical_Operator_out1_4;  /* ufix1 */
  logic [4:0] Switch13_out1;  /* ufix5 */
  logic [4:0] Switch33_out1;  /* ufix5 */
  logic [4:0] Constant9_out1_1;  /* ufix5 */
  logic [4:0] Switch11_out1_1;  /* ufix5 */
  logic [4:0] Constant10_out1_1;  /* ufix5 */
  logic [4:0] Switch12_out1_1;  /* ufix5 */
  logic [4:0] Constant11_out1_1;  /* ufix5 */
  logic [4:0] Switch14_out1_1;  /* ufix5 */
  logic [4:0] Constant12_out1_1;  /* ufix5 */
  logic [4:0] Switch15_out1_1;  /* ufix5 */
  logic [4:0] Switch16_out1_1;  /* ufix5 */
  logic [4:0] Constant13_out1_1;  /* ufix5 */
  logic [4:0] Switch17_out1_1;  /* ufix5 */
  logic [4:0] Constant14_out1_1;  /* ufix5 */
  logic [4:0] Switch18_out1_1;  /* ufix5 */
  logic [4:0] Constant15_out1_1;  /* ufix5 */
  logic [4:0] Switch19_out1_1;  /* ufix5 */
  logic [4:0] Constant16_out1_1;  /* ufix5 */
  logic [4:0] Switch20_out1_1;  /* ufix5 */
  logic [4:0] Switch21_out1_1;  /* ufix5 */
  logic [4:0] Switch13_out1_1;  /* ufix5 */
  ...
  logic [4:0] Switch1_out1_1;  /* ufix5 */
  logic [4:0] Switch34_out1;  /* ufix5 */
  logic [4:0] Bit_Slice_out1_2;  /* ufix5 */
  logic shift_length_exp_a_cor_out1;  /* ufix1 */
  logic [2:0] Bit_Slice1_out1_2;  /* ufix3 */
  logic Compare_To_Zero_out1_1;  /* ufix1 */
  logic Logical_Operator1_out1_3;  /* ufix1 */
  logic [7:0] C1_out1;  /* ufix8 */
  logic [4:0] exp_a_cor_1_sub_cast;  /* ufix5 */
  logic [4:0] exp_a_cor_1_out1;  /* ufix5 */
  logic [4:0] if_shift_length_exp_a_cor_1_out1;  /* ufix5 */
  logic [7:0] dynamic_shift_3;  /* uint8 */
  logic [26:0] bitsll_Sum_shift_length_out1;  /* ufix27 */
  logic [26:0] bitsrl_Sum_1_out1;  /* ufix27 */
  logic [26:0] if_bitget_Sum_Sum_WordLength_out1;  /* ufix27 */
  logic [26:0] C5_out1;  /* ufix27 */
  logic [26:0] if_exp_norm_cfType_Exponent_I_out1;  /* ufix27 */
  logic [23:0] BitSlice6_out1;  /* ufix24 */
  logic BitSlice5_out1;  /* ufix1 */
  logic Bit_Slice13_out1_2;  /* ufix1 */
  logic Bit_Slice12_out1_2;  /* ufix1 */
  logic Bit_Slice10_out1_2;  /* ufix1 */
  logic Bit_Slice11_out1_2;  /* ufix1 */
  logic Bit_Slice14_out1_2;  /* ufix1 */
  logic [2:0] Bit_Slice7_out1_1;  /* ufix3 */
  logic Constant1_out1_2;  /* ufix1 */
  logic [3:0] Bit_Concat_out1_2;  /* ufix4 */
  ...
  logic [3:0] Bit_Slice8_out1_1;  /* ufix4 */
  ...
  logic [3:0] Bit_Slice9_out1_2;  /* ufix4 */
  ...
  logic Logical_Operator1_out1_7;  /* ufix1 */
  ...
  logic [3:0] Bit_Slice4_out1_1;  /* ufix4 */
  logic Bit_Slice_out1_7;  /* ufix1 */
  logic Logical_Operator3_out1_4;  /* ufix1 */
  logic Bit_Slice1_out1_7;  /* ufix1 */
  logic Logical_Operator_out1_9;  /* ufix1 */
  logic Switch6_out1_6;  /* ufix1 */
  logic Bit_Slice2_out1_7;  /* ufix1 */
  logic Logical_Operator1_out1_8;  /* ufix1 */
  logic Bit_Slice3_out1_7;  /* ufix1 */
  logic Logical_Operator2_out1_5;  /* ufix1 */
  logic Switch7_out1_6;  /* ufix1 */
  logic Switch3_out1_7;  /* ufix1 */
  logic [3:0] Bit_Slice5_out1_2;  /* ufix4 */
  logic Bit_Slice_out1_8;  /* ufix1 */
  logic Logical_Operator3_out1_5;  /* ufix1 */
  logic Bit_Slice1_out1_8;  /* ufix1 */
  logic Logical_Operator_out1_10;  /* ufix1 */
  logic Switch6_out1_7;  /* ufix1 */
  logic Bit_Slice2_out1_8;  /* ufix1 */
  logic Logical_Operator1_out1_9;  /* ufix1 */
  logic Bit_Slice3_out1_8;  /* ufix1 */
  logic Logical_Operator2_out1_6;  /* ufix1 */
  logic Switch7_out1_7;  /* ufix1 */
  logic Switch3_out1_8;  /* ufix1 */
  logic Switch6_out1_8;  /* ufix1 */
  logic [3:0] Bit_Slice6_out1_1;  /* ufix4 */
  logic Bit_Slice_out1_9;  /* ufix1 */
  logic Logical_Operator3_out1_6;  /* ufix1 */
  logic Bit_Slice1_out1_9;  /* ufix1 */
  logic Logical_Operator_out1_11;  /* ufix1 */
  logic Switch6_out1_9;  /* ufix1 */
  logic Bit_Slice2_out1_9;  /* ufix1 */
  logic Logical_Operator1_out1_10;  /* ufix1 */
  logic Bit_Slice3_out1_9;  /* ufix1 */
  logic Logical_Operator2_out1_7;  /* ufix1 */
  logic Switch7_out1_8;  /* ufix1 */
  logic Switch3_out1_9;  /* ufix1 */
  logic Bit_Slice1_out1_10;  /* ufix1 */
  logic Logical_Operator_out1_12;  /* ufix1 */
  logic Logical_Operator1_out1_11;  /* ufix1 */
  logic Switch7_out1_9;  /* ufix1 */
  logic Switch3_out1_10;  /* ufix1 */
  logic Switch2_out1_2;  /* ufix1 */
  logic BitSlice1_out1;  /* ufix1 */
  logic sticky_bitget_Sum_1_out1;  /* ufix1 */
  logic BitSlice_out1_1;  /* ufix1 */
  logic BitSlice1_out1_1;  /* ufix1 */
  logic if_bitget_Sum_Sum_WordLength_2_out1;  /* ufix1 */
  logic sticky_bitget_Sum_1_out1_1;  /* ufix1 */
  ...
  logic [23:0] cast_2_like_Mant_tmp_out1;  /* ufix24 */
  logic [23:0] Mant_tmp_cast_2_like_Man_out1;  /* ufix24 */
  logic [23:0] if_bitget_Mant_tmp_1_0_out1;  /* ufix24 */
  logic BitSlice2_out1;  /* ufix1 */
  logic BitSlice4_out1_1;  /* ufix1 */
  logic [7:0] C4_out1;  /* ufix8 */
  logic Sum_0_out1;  /* ufix1 */
  logic [7:0] exp_a_cor_shift_length_1;  /* ufix8 */
  logic [7:0] exp_a_cor_shift_length_out1;  /* ufix8 */
  logic [7:0] C2_out1;  /* ufix8 */
  logic [7:0] if_shift_length_exp_a_cor_out1;  /* ufix8 */
  logic BitSlice2_out1_1;  /* ufix1 */
  logic [7:0] C3_out1;  /* ufix8 */
  logic [7:0] if_Sum_0_out1;  /* ufix8 */
  logic [7:0] if_bitget_Sum_Sum_WordLength_1_out1;  /* ufix8 */
  logic [7:0] C_out1_2;  /* ufix8 */
  logic [7:0] exp_a_cor_1_out1_1;  /* ufix8 */
  logic [7:0] if_bitget_Sum_Sum_WordLength_1_out1_1;  /* ufix8 */
  logic [7:0] if_bitget_Sum_Sum_WordLength_out1_1;  /* ufix8 */
  ...
  logic Exponent_0_out1_2;  /* ufix1 */
  logic [22:0] BitSlice3_out1_1;  /* ufix23 */
  logic Mantissa_0_out1;  /* ufix1 */
  logic alphaExponent_0_Mantissa_out1;  /* ufix1 */
  logic Constant_out1_2;  /* ufix1 */
  logic Switch_out1_1;  /* ufix1 */
  logic alphaaSign_1_bSign_1_out1;  /* ufix1 */
  logic if_Exponent_0_Mantissa_out1;  /* ufix1 */
  logic [7:0] if_aExponent_cfType_Exponent_out1;  /* ufix8 */
  logic opp_signs_exp_b_cfType_out1;  /* ufix1 */
  logic mant_a_0_out1;  /* ufix1 */
  logic alphamant_a_0_opp_signs_out1;  /* ufix1 */
  logic [22:0] BitSet_out1;  /* ufix23 */
  logic [22:0] if_mant_a_0_opp_signs_out1;  /* ufix23 */
  ...
  assign Relational_Operator1_out1 = AE == BE;

  assign Relational_Operator_out1 = AE > BE;

  assign bitconcat_aExponent_aMantissa_out1 = AM >= BM;
  ...
  assign shift_length_exp_a_cor_out1 = Switch34_out1 >= Bit_Slice_out1_2;
